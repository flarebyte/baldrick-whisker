...
> Run unit tests with c8 and produce lcov + summary

**Motivation:** Ensure we track regressions in code coverage

**Run:** `npx baldrick-broth test coverage`

***

### Lint + unit + pest + coverage

**Run:** `npx baldrick-broth test all`
